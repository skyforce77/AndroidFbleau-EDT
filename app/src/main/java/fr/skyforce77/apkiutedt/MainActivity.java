...
public class MainActivity extends Activity
    ...
    public void onSectionAttached(int number) {
        ...
        MainActivity.updateImage(mTitle.toString());
    }
    ...
    public static void updateImage(final String section) {
        String url = "http://www.iut-fbleau.fr/EDT/consulter/voir_new.php?p="+section;
        if(MainActivity.instance.newp) {
